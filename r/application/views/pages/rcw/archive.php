		...
		<section class="blog">
			<div class="blog-title-top">
				<div class="container">
					...
					<?php
						if(count($data)>=1){
							echo "<h2>Conference Archive (".$data[0]['Name'].")</h2>
									<p><a href='archives'>Research Conference Archives</a> > <a href=\"conference?id=".$data[0]['Acronym']."\">".$data[0]['Name']."</a></p>";;
						}
						else{
											...
											<div class=\"col-sm-12\" >
												<div class=\"item-art\">
													...
													<div class=\"text-area\">
														...
														<!-- Title -->
														<a class=\"title-art-sub\" href=\"research?r=".generate_string(5).$data[$i]['SubmissionID'].generate_string(5)."\" style=\"padding-top:50px;\">".$data[$i]['Title']."</a>
														<!-- HR -->
														...
														<div class=\"art-info-sub\">
															...
															<div class=\"art-block-sub\">
																...
																<span>".date ("F d, Y",  strtotime($data[$i]['Date']))."</span>
															</div>
															<!-- User -->
															<div class=\"art-block-sub\">
														...
														<!-- Brief Description -->
														<p>".(strlen($data[$i]['Abstract'])<=100 ? $data[$i]['Abstract']:  substr($data[$i]['Abstract'], 0, 100)."...")."</p>
													</div>
												</div>
											</div>";
								}
